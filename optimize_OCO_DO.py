...
results_folder = 'DO'+str(DATA_OPTION)+'_MOD0'+str(MOD) + '.1_comp2OCO_DLcorrected_train_E-10-30_N40-55_test_E5-15_N45-50_small_DO/'
...
if USE_BEST_PARAMS:
  ...
  best_params = {'learning_rate': 0.0000341467159499725, 'weight_decay': 9.756837399842312e-05, 'max_epochs': 41} #best par of the new mode
